        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {!! app('menu')->handler('secretariats.panel-buttons.revisions')->render('inline') !!}
                    <h4>
                        {{$occupation->name}}: {{trans('secretariats.view_revisions', ['name' => $secretariat->name])}}
                    </h4>
                </div>
                <div class="panel-body">

                    <dl class="timeline">
                    @foreach($secretariat->revisionHistory->reverse() as $history)
                        @if($history->key == 'created_at' && !$history->old_value)
                            ...
                            <dd>{{trans('secretariats.created_this')}}</dd>
                        @else
                            ...
                            <dd>{{trans('secretariats.changed_from_to', [
